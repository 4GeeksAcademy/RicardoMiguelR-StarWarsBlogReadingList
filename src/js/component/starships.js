    ...
    return (
        <>
            <div className="card me-4" style={{width: '18rem', background: 'rgba(255, 255, 255, 0.247)'}}>
                <img src="https://i.blogs.es/e8942b/millennium-falcon/450_1000.jpg" className="img-fluid rounded-circle" alt="..." />
                <div className="card-body">
                    <h5 className="card-title"><b>{props.title}</b></h5>
                    <div className="section-favoYfull">
                        <div className="starships-details mt-4">
                            <Link to={`/starship-details/${props.uid}`}>
                        ...
                        <div className="favorite-position">
                            ...
                            onClick={() => actions.addFavoriteStarship(props.uid)} title="Click to add to favorites">
